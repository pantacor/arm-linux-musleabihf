armv7-eabihf--musl--stable-2024.02-1
...
follow these steps:
    ...
    cd buildroot
    git checkout toolchains.bootlin.com-2024.02.1

    curl http://toolchains.bootlin.com/downloads/releases/toolchains/armv7-eabihf/build_fragments/armv7-eabihf--musl--stable-2024.02-1.defconfig > .config
    make olddefconfig
    make
    make sdk
